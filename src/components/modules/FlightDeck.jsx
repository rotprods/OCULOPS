...
const SPEED_RANGE = { min: 180, max: 860 }
const ALTITUDE_RANGE = { min: 2000, max: 38000 }
...
function formatArea(area, fallback = 'Unresolved airspace') {
...
function buildOpportunityModel(leads) {
    if (!leads.length) {
